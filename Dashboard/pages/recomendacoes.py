...
def show(data):
    ...
    with st.sidebar:
        ...
        As recomendações desta seção:
        
        1. **Priorizam iniciativas** com base em impacto e esforço
        2. **Estruturam um plano de ação** com fases de implementação
        3. **Definem métricas claras** para acompanhamento de resultados
        4. **Estabelecem metas** realistas e mensuráveis
        
        #### Como implementar este plano:
        
        - Inicie com os "quick wins" para obter resultados rápidos
        - Estabeleça um comitê de combate a fraudes interdepartamental
        - Implemente um ciclo de revisão mensal para ajustar estratégias
        - Comunique claramente as mudanças a todas as partes envolvidas
        
        > **Dica**: O sucesso deste plano depende do comprometimento
        > contínuo da liderança e da capacidade de adaptar as estratégias
